/*
  ...
  Ported to Arduino IDE (.ino) by ぽこちゃ技術枠
*/

// Build flags (equivalent to platformio.ini)
#define SD_FAT_TYPE 3
#define FBSD_ENABLE_SD_UPDATER
...
#include "src/scoped_profiler.hpp"
#include "src/MainClass.h"
#include "src/gob_gmv_file.hpp"
#include "src/file_list.hpp"
...
static void loopRender()
{
    ...
    // 2:Load one block of the image and wav from SD
